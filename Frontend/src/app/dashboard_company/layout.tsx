      ...
      <aside className="w-64 text-black p-4  h-screen flex flex-col">
        ...
        <nav className="flex flex-col justify-between flex-1 gap-5 mt-5">
          <div className="flex flex-col gap-5">
            ...
            <Link href={"/reports"} className="transition-all duration-300 font-semibold shadow-lg hover:shadow-xl bg-black text-white hover:bg-gray-900 hover:scale-105 p-3 rounded-md text-lg ">Usuarios</Link>
          </div>
