...
export default function PayPalButton() {
  const clientId = process.env.NEXT_PUBLIC_PAYPAL_CLIENT_ID || "placeholder";

  if (clientId === "placeholder") {
    return (
      <div className="p-4 bg-yellow-50 border border-yellow-200 rounded">
        <p className="text-yellow-800">PayPal not configured. Please set NEXT_PUBLIC_PAYPAL_CLIENT_ID.</p>
      </div>
    );
  }
